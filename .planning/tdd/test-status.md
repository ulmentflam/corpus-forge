...
- Surface: LICENSE (re-pin, Apache-2.0 not MIT), CHANGELOG.md (Keep-a-Changelog header + `## [0.1.0b1] - YYYY-MM-DD` entry + SQLite/CI/MCP/Claude milestone anchors), CONTRIBUTING.md (`make dev` + `make ci` + commit-style), CODE_OF_CONDUCT.md (Contributor Covenant 2.1 + evan@qwerky.ai), SECURITY.md (`evan@qwerky.ai` + supported `0.1.x` + reporting flow).
