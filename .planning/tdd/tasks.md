...
| D-08 | CLI subcommands `migrate revision` + `migrate history` | D-07 | `corpus_forge/cli.py`, `tests/unit/test_cli_migrate.py` | low | done | tdd-tester | Wave 3; RED `(pending commit)`; 4/4 tests fail "Got unexpected extra argument" — coder lands subcommands |
