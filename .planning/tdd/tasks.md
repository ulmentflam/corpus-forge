...
| R3-04 | `eval/runner.py` — `evaluate_retriever` + `report` + JSON dump + pinned baseline test | R3-02, R3-03 | `corpus_forge/eval/runner.py`, `tests/unit/test_eval_runner.py` | med | green | tdd-coder | 11/11 tests pass. Pinned NDCG@10 floor 0.80; measured baseline 1.0 (20-point headroom). Pyrefly side-fix: GradedMap alias. Full unit 1561/0/4 skipped+xfail; coverage 90.81%. |
