...
def test_coc_lists_contact_email(coc_text: str) -> None:
    assert "evan@jwo3.io" in coc_text, (
        "CODE_OF_CONDUCT must list evan@jwo3.io as the enforcement contact"
    )
...
def test_security_has_reporting_contact(security_text: str) -> None:
    assert "evan@jwo3.io" in security_text, (
        "SECURITY must list evan@jwo3.io for vulnerability reports"
    )
